...
constexpr DiagnosticTemplate kEnglishDiagnostics[] = {
    ...
    {DiagnosticId::ContinueOutsideLoop, "'weier' can only be used inside a loop"},
    {DiagnosticId::FunctionDeclarationInBlock,
     "function declarations are only allowed at global scope"},
...
constexpr DiagnosticTemplate kLimburgishDiagnostics[] = {
    ...
    {DiagnosticId::InvalidTableKey, "mepke-sjleutel moot eine teks of nommer zien"},
    ...
    {DiagnosticId::ContinueOutsideLoop, "'weier' kin allein binne ein lus gebroek waere"},
    {DiagnosticId::FunctionDeclarationInBlock,
     "funksiedeclaraties zien allein toegestaon op globaal niveau"},
